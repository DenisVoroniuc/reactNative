...
export const isSetEmail = (a: GenericAction): a is SetEmail =>
  a.type === ActionTypes.SetEmail;

export type SetPassword = GenericActionWithPayload<
...
export const isSetPassword = (a: GenericAction): a is SetPassword =>
  a.type === ActionTypes.SetPassword;

export type SetPasswordConfirmation = GenericActionWithPayload<
  ActionTypes.SetPasswordConfirmation,
  string
>;
...
export const isSetPasswordConfirmation = (
  a: GenericAction
): a is SetPasswordConfirmation =>
  a.type === ActionTypes.SetPasswordConfirmation;

export type SetFirstName = GenericActionWithPayload<
...
export const isSetFirstName = (a: GenericAction): a is SetFirstName =>
  a.type === ActionTypes.SetFirstName;

export type SetLastName = GenericActionWithPayload<
  ActionTypes.SetLastName,
  string
>;
...
export const isSetLastName = (a: GenericAction): a is SetLastName =>
  a.type === ActionTypes.SetLastName;
...
export const isSubmit = (a: GenericAction): a is Submit =>
  a.type === ActionTypes.Submit;
...
export const isSaveError = (a: GenericAction): a is SaveError =>
  a.type === ActionTypes.SaveError;

export type SaveSuccess = GenericActionWithPayload<
  ActionTypes.SaveSuccess,
  string
>;
...
export const isSaveSuccess = (a: GenericAction): a is SaveSuccess =>
  a.type === ActionTypes.SaveSuccess;
...
export const isActions = (a: GenericAction): a is Actions =>
